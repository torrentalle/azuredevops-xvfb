...
describe('Start Xvfv task tests', function () {
    ...
    it('should succeed with inputs', function(done: MochaDone) {
        this.timeout(10000);
    ...
    it('should succeed wit default inputs', function(done: MochaDone) {
        this.timeout(10000);

        let tp = path.join(__dirname, 'StartXvfb', 'success-default.js');
        let tr: ttm.MockTestRunner = new ttm.MockTestRunner(tp);
